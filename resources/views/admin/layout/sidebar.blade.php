    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ Request::is('admin/amenity/view')||Request::is('admin/room/view') ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown"><i class="fa fa-wrench"></i><span>Room Section</span></a>
            ...
            Request::is('admin/page/reset_password') ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ Request::is('admin/page/image-gallery') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_page_image_gallery') }}"><i class="fa fa-angle-right"></i> Photo Gallery</a></li>
            ...
            <li class="nav-item dropdown {{ Request::is('admin/subscriber/show')||Request::is('admin/subscriber/send-email') ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown"><i class="fa fa-user-plus"></i><span>Subscribers</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="{{ Request::is('admin/customers') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_customer') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Customers"><i class="fa fa-users"></i> <span>Customers</span></a></li>
            ...
            <li class="{{ Request::is('admin/image/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_image_view') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Photo Gallery"><i class="fa fa-picture-o"></i> <span>Photo Gallery</span></a></li>
            ...
            <li class="{{ Request::is('admin/faq/*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin_faq_view') }}" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="FAQ"><i class="fa fa-comments"></i> <span>FAQ</span></a></li>
