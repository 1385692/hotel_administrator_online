        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-5 col-sm-12 right">
                <div class="sidebar-container" id="sticky_sidebar">
                    <div class="widget">
                        <h2>Precio de habitación por noche</h2>
                        <div class="price">
                            S/{{ $single_room_data->price }}
                        </div>
                    </div>
                    <div class="widget">
                        <h2>Reserva esta habitación</h2>
                        <form action="{{ route('cart_submit') }}" method="post">
                            ...
                            <button type="submit" class="book-now">Añadir</button>
                        </form>
                    </div>
