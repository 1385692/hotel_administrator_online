...
<html lang="en">
    <head>
        ...
        <title>La Casona de Jerusalén</title>        
        ...
        <style>
            ...
            .primary-color,
            .testimonial .swiper-slide .information p,
            .home-rooms .inner .text a.post-title {
            ...
            .inputBox input,
            .inputBox input:valid ~ span.label,
            .inputBox input:focus ~ span.label,
            .page-content .sub {
                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">        
                                ...
                                <li class="nav-item">
                                    <a href="javascript:void;" class="nav-link dropdown-toggle">Habitaciones</a>
                                ...
                                <li class="nav-item">
                                    <a href="javascript:void;" class="nav-link dropdown-toggle">Galería</a>
                                    <ul class="dropdown-menu">

                                        @if($global_page_data->image_gallery_status == 1 || $global_page_data->video_gallery_status == 1)
                                        <li class="nav-item">
                                            <a href="{{ route('image_gallery') }}" class="nav-link">{{ $global_page_data->image_gallery_heading }}</a>
                                        </li>
                                        @endif
        ...
        <div class="footer">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <div class="item">
                            <h2 class="heading">Enlaces Rápidos</h2>
                            <ul class="useful-links">
                                @if($global_page_data->image_gallery_status == 1)
                                <li><a href="{{ route('image_gallery') }}">{{ $global_page_data->image_gallery_heading }}</a></li>
                                @endif
                                @if($global_page_data->video_gallery_status == 1)
                    ...
                    <div class="col-md-3">
                        <div class="item">
                            <h2 class="heading">Enlaces Útiles</h2>
                            <ul class="useful-links">
                    ...
                    <div class="col-md-3">
                        <div class="item">
                            ...
                            <div class="list-item">
                                ...
                                <div class="right">
                                    {{-- Colocar el texto en dos lineas --}}
                                    {!! nl2br
                    ...
                    <div class="col-md-3">
                        <div class="item">
                            ...
                            <p>
                                Para recibir las últimas noticias y otros excelentes artículos, suscríbase aquí: 
                            </p>
                            <form action="{{ route('subscriber_send_email') }}" method="post" class="form_subscribe_ajax">
                                ...
                                <div class="form-group">
                                    <input type="submit" class="btn btn-primary" value="Suscríbase Ahora">
                                </div>
                            </form>
                        </div>
                    </div>
