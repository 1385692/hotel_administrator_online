...
class BookingController extends Controller
{
    ...
    public function checkout()
    {
        ...
        if (!session()->get('cart_room_id')) {
            return redirect()->back()->with('error', 'There is not item in the cart.');
        }
    ...
    public function paypal(Request $request)
    {
        ...
        //Pasar la variable de pago a la sesión
        session(['total_amount' => $request->price]);
    ...
    public function success(Request $request)
    {
        ...
        if(isset($response['status']) && $response['status'] == 'COMPLETED') {
            ...
            $obj->transaction_id = 'PAYID-' . $response['id'];
            $obj->payment_method = 'PayPal';
            $obj->paid_amount = $total_amount;
            ...
            // Send email
            $subject = 'New Order';
            $message = 'You have made an order for hotel booking. The booking information is given bellow: <br>';
            $message .= '<br>Order No: '. $order_no;
            $message .= '<br>Transaction ID: '.'PAYID-' . $response['id'];
            $message .= '<br>Payment Method: PayPal';
            $message .= '<br>Paid Amount: $'. $total_amount;
