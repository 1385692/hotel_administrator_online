...
class AdminPageController extends Controller
{
    ...
    public function about_update(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Content is updated successfully');
    }
    ...
    public function signup_update(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Sign Up is updated successfully');
    }
    ...
    public function signin_update(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Sign In is updated successfully');
    }
    ...
    public function forget_password_update(Request $request)
    {
        ...
        return redirect()->back()->with('success','Forget Password is updated successfully');
    }
    ...
    public function reset_password_update(Request $request)
    {
        ...
        return redirect()->back()->with('success','Reset Password is updated successfully');
    }
}
