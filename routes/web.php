...
Route::get('/image-gallery', [ImageController::class, 'index'])->name('image_gallery');
...
Route::post('paypal/', [BookingController::class, 'paypal'])->name('paypal');
...
Route::post('stripe/{price}', [BookingController::class, 'stripe'])->name('stripe');
...
Route::group(['middleware' => 'admin:admin'], function(){
    ...
    Route::get('/admin/image/view', [AdminImageController::class, 'index'])->name('admin_image_view');
    Route::get('/admin/image/add', [AdminImageController::class, 'add'])->name('admin_image_add');
    Route::post('/admin/image/store', [AdminImageController::class, 'store'])->name('admin_image_store');
    Route::get('/admin/image/edit/{id}', [AdminImageController::class, 'edit'])->name('admin_image_edit');
    Route::post('/admin/image/update/{id}', [AdminImageController::class, 'update'])->name('admin_image_update');
    Route::get('/admin/image/delete/{id}', [AdminImageController::class, 'delete'])->name('admin_image_delete');
